...
Public Class receiptfees
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ORIONSCHOOLACCOUNTSWIZARD.receiptfees.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedreceiptfees
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As receiptfees = New receiptfees()
        rpt.Site = Me.Site
        Return rpt
    End Function
