...
Public Class uniformpaymentsreport

    Private Sub uniformpaymentsreport_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
