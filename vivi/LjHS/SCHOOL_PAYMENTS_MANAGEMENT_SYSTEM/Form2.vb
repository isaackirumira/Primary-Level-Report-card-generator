Public Class Form2
    ...
    Private Sub USEBUDGETEDMONEYToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles USEBUDGETEDMONEYToolStripMenuItem.Click
        vote.Show()
