...
Public Class meal_report

    Private Sub meal_report_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            Dim crp As ThosePayedFunctionRequirements = New ThosePayedFunctionRequirements()
