    ...
    Public Sub saveimporteddataintostudentstbl()
        Try
            ...
            For Each row As DataGridViewRow In dataGridView1.Rows
                ...
                Dim cmd As New MySqlCommand("INSERT INTO school_payments.registration(fname,Class,Year,term,cond) VALUES(@Name,@Class,@Year,@term,@cond)", con)
                cmd.Parameters.AddWithValue("@name", row.Cells("name").Value)
                'cmd.Parameters.AddWithValue("@parent", row.Cells("parent").Value)
                ...
                cmd.Parameters.AddWithValue("@cond", Form3.txt_condition.Text)
                cmd.Parameters.AddWithValue("@Class", Form3.txt_class.Text)
                cmd.Parameters.AddWithValue("@Year", Form3.txt_year.Text)
                cmd.Parameters.AddWithValue("@term", Form3.txt_term.Text)
