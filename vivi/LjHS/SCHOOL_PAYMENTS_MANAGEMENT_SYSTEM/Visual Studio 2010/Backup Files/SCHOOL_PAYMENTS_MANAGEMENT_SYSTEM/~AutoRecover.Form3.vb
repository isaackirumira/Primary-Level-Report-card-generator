...
Public Class Form3
    ...
    Public Sub fill_data_grid()
        Try
            ...
            Dim cmdDatabase As MySqlCommand = New MySqlCommand("Select id,fname,sname,oname,date,parent,telephone,sex,address,class,year,term,cond  from school_payments.registration ;", conDatabase)
    ...
    Private Sub DataGridView1_CellContentClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DataGridView1.CellContentClick
        ...
        Me.txt_sname.Text = DataGridView1.Item(2, i).Value
        Me.txt_oname.Text = DataGridView1.Item(3, i).Value
        Me.txt_class.Text = DataGridView1.Item(9, i).Value
        Me.txt_sex.Text = DataGridView1.Item(7, i).Value
        Me.txt_term.Text = DataGridView1.Item(11, i).Value
        Me.txt_condition.Text = DataGridView1.Item(12, i).Value
        Me.txt_year.Text = DataGridView1.Item(10, i).Value
        Me.txt_telephone.Text = DataGridView1.Item(6, i).Value
        Me.txt_parent.Text = DataGridView1.Item(5, i).Value
        Me.DateTimePicker1.Text = DataGridView1.Item(4, i).Value
        Me.txt_address.Text = DataGridView1.Item(8, i).Value
        fill_image()
    ...
    Private Sub UPDATEToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles UPDATEToolStripMenuItem.Click
        If (txt_fname.Text.Length > 0 And txt_sname.Text.Length > 0 And txt_year.Text.Length > 0 And txt_term.Text.Length > 0 And txt_parent.Text.Length > 0 And txt_address.Text.Length > 0 And txt_telephone.Text.Length > 0 And txt_sex.Text.Length > 0) Then
            Try
                ...
                Dim myConnection As String = "datasource=localhost;port=3306;username=root;"
                Dim mycon As MySqlConnection = New MySqlConnection(myConnection)
                Dim SelectCommand As MySqlCommand = New MySqlCommand("update school_payments.registration set fname='" & txt_fname.Text & "',sname='" & txt_sname.Text & "',oname='" & txt_oname.Text & "',date='" & DateTimePicker1.Text & "',parent='" & txt_parent.Text & "',telephone='" & txt_telephone.Text & "',sex='" & txt_sex.Text & "',address='" & txt_address.Text & "',class='" & txt_class.Text & "',year='" & txt_year.Text & "',term='" & txt_term.Text & "',cond='" + txt_condition.Text + "' where id='" & txt_id.Text & "' ", mycon)
                Dim myReader As MySqlDataReader
    ...
    Private Sub SEARCHBYNAMEToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SEARCHBYNAMEToolStripMenuItem.Click
        Try
            Dim constring As String = "datasource=localhost;port=3306;username=root;"
            Dim conDatabase As MySqlConnection = New MySqlConnection(constring)
            Dim cmdDatabase As MySqlCommand = New MySqlCommand("Select id,fname,sname,oname,date,parent,telephone,sex,address,class,year,term,cond  from school_payments.registration WHERE fname='" + txt_fname.Text + "' and sname='" + txt_sname.Text + "' ;", conDatabase)
            Dim sda As MySqlDataAdapter = New MySqlDataAdapter()
            sda.SelectCommand = cmdDatabase
            Dim dbDataset As DataTable = New DataTable()
            sda.Fill(dbDataset)
    ...
    Private Sub ToolStripMenuItem1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SAVEToolStripMenuItem1.Click
        ...
        If (txt_fname.Text.Length > 0 And txt_sname.Text.Length > 0 And txt_year.Text.Length > 0 And txt_term.Text.Length > 0 And txt_parent.Text.Length > 0 And txt_address.Text.Length > 0 And txt_telephone.Text.Length > 0 And txt_sex.Text.Length > 0) Then
            Try
                ...
                Dim myConnection As String = "datasource=localhost;port=3306;username=root;"
                Dim mycon As MySqlConnection = New MySqlConnection(myConnection)
                Dim SelectCommand As MySqlCommand = New MySqlCommand("insert into school_payments.registration(fname,sname,oname,date,parent,telephone,sex,address,class,year,term,cond) values('" & txt_fname.Text & "','" & txt_sname.Text & "','" & txt_oname.Text & "','" & DateTimePicker1.Text & "','" & txt_parent.Text & "','" & txt_telephone.Text & "','" & txt_sex.Text & "','" & txt_address.Text & "','" & txt_class.Text & "','" & txt_year.Text & "','" & txt_term.Text & "','" + txt_condition.Text + "') ", mycon)
                Dim myReader As MySqlDataReader
