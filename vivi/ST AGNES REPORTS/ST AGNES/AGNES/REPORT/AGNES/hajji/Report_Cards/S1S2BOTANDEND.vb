...
Public Class S1S2BOTANDEND
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LuyanziCollege.S1S2BOTANDEND.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedS1S2BOTANDEND
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As S1S2BOTANDEND = New S1S2BOTANDEND()
        rpt.Site = Me.Site
        Return rpt
    End Function
