...
Public Class S3S4DONEBOTEND
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LuyanziCollege.S3S4DONEBOTEND.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedS3S4DONEBOTEND
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As S3S4DONEBOTEND = New S3S4DONEBOTEND()
        rpt.Site = Me.Site
        Return rpt
    End Function
