...
Public Class ANALYSEALEVEL
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LuyanziCollege.ANALYSEALEVEL.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedANALYSEALEVEL
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ANALYSEALEVEL = New ANALYSEALEVEL()
        rpt.Site = Me.Site
        Return rpt
    End Function
