...
Public Class s3s4singlefinalfinal
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "s3s4singlefinalfinal.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LuyanziCollege.s3s4singlefinalfinal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cacheds3s4singlefinalfinal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As s3s4singlefinalfinal = New s3s4singlefinalfinal()
        rpt.Site = Me.Site
        Return rpt
    End Function
