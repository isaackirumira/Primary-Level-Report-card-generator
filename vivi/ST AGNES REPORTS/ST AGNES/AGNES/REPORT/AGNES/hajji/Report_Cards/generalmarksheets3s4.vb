...
Public Class generalmarksheets3s4
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "generalmarksheets3s4.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LuyanziCollege.generalmarksheets3s4.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedgeneralmarksheets3s4
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As generalmarksheets3s4 = New generalmarksheets3s4()
        rpt.Site = Me.Site
        Return rpt
    End Function
