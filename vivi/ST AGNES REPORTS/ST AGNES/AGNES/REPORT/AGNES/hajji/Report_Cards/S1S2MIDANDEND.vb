...
Public Class S1S2MIDANDEND
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LuyanziCollege.S1S2MIDANDEND.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedS1S2MIDANDEND
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As S1S2MIDANDEND = New S1S2MIDANDEND()
        rpt.Site = Me.Site
        Return rpt
    End Function
