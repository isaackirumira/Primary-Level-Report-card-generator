...
Public Class S5_POINTS_RANK
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LuyanziCollege.S5 POINTS RANK.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedS5_POINTS_RANK
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As S5_POINTS_RANK = New S5_POINTS_RANK()
        rpt.Site = Me.Site
        Return rpt
    End Function
