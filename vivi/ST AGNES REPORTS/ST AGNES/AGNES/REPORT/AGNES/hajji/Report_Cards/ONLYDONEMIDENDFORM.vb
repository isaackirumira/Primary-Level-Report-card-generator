...
Public Class ONLYDONEMIDENDFORM

    Private Sub ONLYDONEMIDENDFORM_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            Dim crp As ONLYDONES3S4MIDEND = New ONLYDONES3S4MIDEND()
