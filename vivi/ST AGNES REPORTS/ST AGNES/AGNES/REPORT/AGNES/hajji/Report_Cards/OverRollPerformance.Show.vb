...
Public Class OverRollPerformance
    ...
    Public Sub fill_names()
        Try
            Dim myConnection As String = "datasource=localhost;port=3306;username=root;"
            Dim mycon As MySqlConnection = New MySqlConnection(myConnection)
            Dim SelectCommand As MySqlCommand = New MySqlCommand("Select * from reportcards.students where year='" + RecordMarks.txt_year.Text + "'  and class='" + RecordMarks.txt_class.Text + "' ;", mycon)
            Dim myReader As MySqlDataReader
    ...
    Public Sub autofillgrid()
        Try
            ...
            Dim cmdDatabase As MySqlCommand = New MySqlCommand("Select subject,mid,end,average,grade,aggregate,remark from reportcards.marks where name='" + txt_name.Text + "' and year='" + RecordMarks.txt_year.Text + "' and term='" + RecordMarks.txt_term.Text + "' and class='" + RecordMarks.txt_class.Text + "' and aggregate<>'-' and aggregate<>'x' and aggregate<>'0' order by aggregate asc limit 4  ;", conDatabase)
