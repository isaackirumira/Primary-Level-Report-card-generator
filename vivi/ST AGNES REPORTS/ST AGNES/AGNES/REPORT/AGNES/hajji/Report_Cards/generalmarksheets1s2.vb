...
Public Class generalmarksheets1s2
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "generalmarksheets1s2.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LuyanziCollege.generalmarksheets1s2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedgeneralmarksheets1s2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As generalmarksheets1s2 = New generalmarksheets1s2()
        rpt.Site = Me.Site
        Return rpt
    End Function
