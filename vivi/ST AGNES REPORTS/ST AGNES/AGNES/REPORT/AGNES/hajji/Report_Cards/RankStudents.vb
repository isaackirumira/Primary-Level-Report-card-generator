...
Public Class RankStudents
    ...
    Public Sub savetotals()
        ...
        Try
            For Each row As DataGridViewRow In DataGridView1.Rows
                ...
                cmd.Parameters.AddWithValue("@CLASSTEACTHER", commt)
                cmd.Parameters.AddWithValue("@HEADTEACTHER", commt)
    ...
    Public Sub checktoseeifrankisdone()
        Try
            Dim myConnection As String = "datasource=localhost;port=3306;username=root;"
            Dim mycon As MySqlConnection = New MySqlConnection(myConnection)
            Dim SelectCommand As MySqlCommand = New MySqlCommand("Select distinct(name),class,term,year,TotalMark,Position,CLASSTEACTHER,HEADTEACTHER from reportcards.positions where class='" + RecordMarks.txt_class.Text + "' and year='" + RecordMarks.txt_year.Text + "' and term='" + RecordMarks.txt_term.Text + "';", mycon)
            Dim myReader As MySqlDataReader
