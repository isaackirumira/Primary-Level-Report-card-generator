...
Public Class EditMarks
    ...
    Public Sub alevelgrading()
        Try
            ...
            ElseIf (Double.Parse(DataGridView1.Item(3, i2).Value) >= 90 And Double.Parse(DataGridView1.Item(3, i2).Value) <= 89.5) Then
            ...
            ElseIf (Double.Parse(DataGridView1.Item(3, i2).Value) >= 65 And Double.Parse(DataGridView1.Item(3, i2).Value) <= 79.5) Then
