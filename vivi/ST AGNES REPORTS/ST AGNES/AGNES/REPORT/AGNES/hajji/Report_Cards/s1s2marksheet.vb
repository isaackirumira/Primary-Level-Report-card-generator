...
Public Class s1s2marksheet
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LuyanziCollege.s1s2marksheet.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cacheds1s2marksheet
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As s1s2marksheet = New s1s2marksheet()
        rpt.Site = Me.Site
        Return rpt
    End Function
