...
Public Class ALEVELSCIENCE
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LuyanziCollege.ALEVELSCIENCE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedALEVELSCIENCE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ALEVELSCIENCE = New ALEVELSCIENCE()
        rpt.Site = Me.Site
        Return rpt
    End Function
