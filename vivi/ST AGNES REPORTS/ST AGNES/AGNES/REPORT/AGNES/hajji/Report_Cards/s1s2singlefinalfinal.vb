...
Public Class s1s2singlefinalfinal
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "s1s2singlefinalfinal.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LuyanziCollege.s1s2singlefinalfinal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cacheds1s2singlefinalfinal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As s1s2singlefinalfinal = New s1s2singlefinalfinal()
        rpt.Site = Me.Site
        Return rpt
    End Function
