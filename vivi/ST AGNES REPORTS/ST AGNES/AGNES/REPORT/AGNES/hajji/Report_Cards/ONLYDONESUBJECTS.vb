...
Public Class ONLYDONESUBJECTS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LuyanziCollege.ONLYDONESUBJECTS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedONLYDONESUBJECTS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ONLYDONESUBJECTS = New ONLYDONESUBJECTS()
        rpt.Site = Me.Site
        Return rpt
    End Function
