...
Public Class NURSERYREPORTS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LuyanziCollege.NURSERYREPORTS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedNURSERYREPORTS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As NURSERYREPORTS = New NURSERYREPORTS()
        rpt.Site = Me.Site
        Return rpt
    End Function
