...
Public Class S1PRINTALLDONE
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LuyanziCollege.S1PRINTALLDONE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedS1PRINTALLDONE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As S1PRINTALLDONE = New S1PRINTALLDONE()
        rpt.Site = Me.Site
        Return rpt
    End Function
