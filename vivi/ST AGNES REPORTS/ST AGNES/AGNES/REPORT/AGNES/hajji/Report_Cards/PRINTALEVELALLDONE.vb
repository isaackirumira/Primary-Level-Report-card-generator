...
Public Class PRINTALEVELALLDONE
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LuyanziCollege.PRINTALEVELALLDONE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPRINTALEVELALLDONE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PRINTALEVELALLDONE = New PRINTALEVELALLDONE()
        rpt.Site = Me.Site
        Return rpt
    End Function
