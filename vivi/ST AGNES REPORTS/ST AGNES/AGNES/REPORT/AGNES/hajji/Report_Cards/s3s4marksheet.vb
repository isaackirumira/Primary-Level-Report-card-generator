...
Public Class s3s4marksheet
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LuyanziCollege.s3s4marksheet.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cacheds3s4marksheet
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As s3s4marksheet = New s3s4marksheet()
        rpt.Site = Me.Site
        Return rpt
    End Function
