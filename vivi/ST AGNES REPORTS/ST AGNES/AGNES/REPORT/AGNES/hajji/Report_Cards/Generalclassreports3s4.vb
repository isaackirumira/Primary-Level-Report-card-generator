...
Public Class Generalclassreports3s4

    Private Sub Generalclassreports3s4_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            Dim crp As ONLYDONESUBJECTS = New ONLYDONESUBJECTS()
