...
Public Class finestgradereport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LuyanziCollege.finestgradereport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedfinestgradereport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As finestgradereport = New finestgradereport()
        rpt.Site = Me.Site
        Return rpt
    End Function
